rm *.tsv
scp -p ads@adsset:/proj/ads_abstracts/config/affils/Affiliations_all.tsv ./affils_CSG_raw.tsv
scp -p ads@adsset:/proj/ads_abstracts/config/affils/parent_child_facet_inst.tsv ./pc_facet_CSG_raw.tsv
